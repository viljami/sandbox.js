(function(){
  var lib = (function(){
    ...
    return {
      ...
      createItem: function(vertices, position){
        var item = {
  ...
  .then(function(){
    ...
    triangleVertexPositionBuffer = lib.createItem(triangleVertices, [-1.5, 0.0, -7.0]);
    squareVertexPositionBuffer = lib.createItem(squareVertices, [3.0, 0.0, 0.0]);
  });
})();
